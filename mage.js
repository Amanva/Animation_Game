    ...
    update() {
        ...
        if(this.dead){
            ...
            if(this.state != this.states.jump){
                ...
                if(this.game.attack && !this.specialAttack1 && !this.specialAttack2){
                    this.shoot = true;
                    this.velocity.x = 0;
                }
            ...
            if(this.specialAttack1){
                ...
                if(this.animations[this.states.skullAttack][this.facing].isAlmostDone(TICK)){
                    if(this.facing == 0){
                    this.game.addEntityToBegin(new WaterBall(this.game, this.x+100, this.y+140));
                    }
                     if(this.facing == 1){
                    this.game.addEntityToBegin(new WaterBall(this.game, this.x, this.y+140));
                    }
                    this.curMana -= 50;
                    this.animations[this.state][this.facing].elapsedTime = 0;
                    this.timetoShoot = 0;
            ...
            if(this.state != this.states.jump){
                ...
                if(this.velocity.x == 0 && !this.shoot && !this.specialAttack1 && !this.specialAttack2){
                    this.state = this.states.idle;
                }
