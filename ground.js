const GSCALE = 1;
class Ground {
    constructor(game, x, y, w, height) {
        Object.assign(this, { game, x, y, w, height});
    ...
    updateBB() {
        this.lastBB = this.BB;
        this.BB = new BoundingBox(this.x, this.y, this.w, (64*GSCALE));
    ...
    draw(ctx) {
        ...
        ctx.drawImage(this.spritesheet, 0, 255, 256, 64, this.x + i * (256*GSCALE)-this.game.camera.x, this.y-this.height, (256*GSCALE), (64*GSCALE));
        }
        ctx.strokeStyle = 'Red';
